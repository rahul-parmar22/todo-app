...
}              //aa method ne je pan data ma means user ma call kari hoy te user no badho data aani pase aavi jay..ane aa this.password e tyathi j aavel chhe..
//ahi upar khas return to aapvu j ..jo return nahi aapo to jyare aa fun login samaye call thashe to error aavshe tya...         
// bcrypt.compare(pw, this.password) // pelo password hamesha plain password from user pasethi hoy te rakhvu karan ke Do hashed values compare nahi hoti ❌


//Instance Methods (custom methods on document)
//Tum document ke instance ke liye methods define kar sakte ho.

// userSchema.methods.sayHi = function() {
//     console.log(`Hi, my name is ${this.name}`);
// }
// const user = await User.findOne({name: "Aman"});
// user.sayHi(); // Hi, my name is Aman          //ahi user nu je aman chhe e aa method ma aavi gyu ane upar this.name chhe tya use thayu...
...
// 🔥 Important baat (isko bold me yaad rakho)
// MongoDB kabhi bhi name ya email se user identify nahi karta
// hamesha _id se karta hai
